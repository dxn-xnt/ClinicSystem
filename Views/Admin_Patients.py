...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.SortByBox.setItemText(0, _translate("MainWindow", "Ingrown"))
        self.SortByBox.setItemText(1, _translate("MainWindow", "Kabag"))
        self.SortByBox.setItemText(2, _translate("MainWindow", "Panuhot"))
        self.SortOrderBox.setItemText(0, _translate("MainWindow", "Date Diagnosed"))
        self.SortOrderBox.setItemText(1, _translate("MainWindow", "Gender"))
        self.SortOrderBox.setItemText(2, _translate("MainWindow", "Name (Aphabetical)"))
